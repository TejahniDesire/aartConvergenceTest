...
for i in range(trials + 1):
    ...
    radii_I0_Thin_i, theta = tls.radii_of_theta(I0)
    radii_I1_Thin_i, theta = tls.radii_of_theta(I1)
    radii_I2_Thin_i, theta = tls.radii_of_theta(I2)
    radii_cumulative_Thin_i, theta = tls.radii_of_theta(I0 + I1 + I2)
    ...
    radii_I0_Thick_i, theta = tls.radii_of_theta(I0_Absorb)
    radii_I1_Thick_i, theta = tls.radii_of_theta(I1_Absorb)
    radii_I2_Thick_i, theta = tls.radii_of_theta(I2_Absorb)
    radii_FullAbsorption_Thick_i, theta = tls.radii_of_theta(Absorbtion_Image)
